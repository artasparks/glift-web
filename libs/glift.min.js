/*
 ...
 --------------------------------------
*/
(function(a){var b=b||a.glift||{};a&&(a.glift=b)})(window);glift.global={version:"0.19.1",debugMode:!1,performanceDebugLevel:"NONE",perf:{},instanceRegistry:{},activeInstanceId:null,disabledZoom:!1,addedCssClasses:!1};
...
glift.dom={elem:function(a){var b=glift.util.typeOf(a);return"string"===b?(b=document.getElementById(a),null===b?null:new glift.dom.Element(b,a)):"object"===b&&a.nodeType&&1===a.nodeType?new glift.dom.Element(a):null},newDiv:function(a){var b=glift.dom.elem(document.createElement("div"));b.attr("id",a);return b},convertText:function(a,b){a=glift.dom.sanitize(a);for(var c=glift.dom.newElem("div"),d=a.split("\n"),e=0;e<d.length;e++){var f=d[e],g={margin:0,padding:0,"min-height":"1em"};if(b)for(var h in b)g[h]=
b[h];g=glift.dom.newElem("p").css(g);g.html(f);c.append(g)}return c},newElem:function(a){return a?glift.dom.elem(document.createElement(a+"")):null},Element:function(a,b){this.el=a;this.id=b||null}};
...
glift.displays.cropbox={LINE_EXTENSION:0.5,DEFAULT_EXTENSION:0,OVERFLOW:1.5,create:function(a,b,c,d){return new glift.displays._CropBox(a,b,c,d)},getFromRegion:function(a,b,c){var d=glift.util,e=glift.enums.boardRegions;a=a||e.ALL;var f=(c=c||!1)?1:0;b=c?b+1:b-1;var g=Math.ceil(b/2),h=0,k=0,l=b,m=b,n=c=this.DEFAULT_EXTENSION,p=this.DEFAULT_EXTENSION,q=this.DEFAULT_EXTENSION;switch(a){case e.LEFT:m=g+1+f;q=this.LINE_EXTENSION;break;case e.RIGHT:k=g-1-f;n=this.LINE_EXTENSION;break;case e.TOP:l=g+1+
f;p=this.LINE_EXTENSION;break;case e.BOTTOM:h=g-1-f;c=this.LINE_EXTENSION;break;case e.TOP_LEFT:l=g+1+f;p=this.LINE_EXTENSION;m=g+2+f;q=this.LINE_EXTENSION;break;case e.TOP_RIGHT:l=g+1+f;p=this.LINE_EXTENSION;k=g-2-f;n=this.LINE_EXTENSION;break;case e.BOTTOM_LEFT:h=g-1-f;c=this.LINE_EXTENSION;m=g+2+f;q=this.LINE_EXTENSION;break;case e.BOTTOM_RIGHT:h=g-1-f,c=this.LINE_EXTENSION,k=g-2-f,n=this.LINE_EXTENSION}a=glift.displays.bbox.fromPts(d.point(k,h),d.point(m,l));d=glift.displays.bbox.fromPts(d.point(n,
c),d.point(q,p));return glift.displays.cropbox.create(a,d,0,b)}};glift.displays._CropBox=function(a,b,c,d){this._cbox=a;this._extBox=b};
...
(function(){glift.displays.environment={get:function(b){var c=glift.util.point;if(b.heightOverride&&b.widthOverride)c=glift.displays.bbox.fromPts(c(0,0),c(b.widthOverride,b.heightOverride));else if(b.boardBox)c=b.boardBox;else if(b.divId)c=glift.displays.bbox.fromDiv(b.divId);else throw Error("No Bounding Box defined for display environment!");return new a(b,c)},getInitialized:function(a){return glift.displays.environment.get(a).init()}};var a=function(a,c){this.bbox=c;this.divId=a.divId||"glift_display";
...
"spacing");for(var h in c)a.attr(h,c[h]);this.svg.child(this.idGen.tempIconGroup()).appendAndAttach(a);return this},clearTempText:function(a){this.svg.rmChild(this.idGen.tempIconText(a));(a=glift.dom.elem(this.idGen.tempIconText(a)))&&a.remove()},createIconSelector:function(a,b){},destroyIconSelector:function(){},destroyTempIcons:function(){this.svg.child(this.idGen.tempIconGroup()).emptyChildrenAndUpdate();return this},buttonId:function(a){return glift.displays.gui.elementId(this.divId,glift.enums.svgElements.BUTTON,
...
glift.displays.statusbar._StatusBar.prototype={draw:function(){this.iconBar.draw();this.setPageNumber(this.pageIndex,this.totalPages);return this},gameInfo:function(a){var b=this.widget.wrapperDiv,c=b+"_gameinfo_wrapper",d=glift.dom.elem(b),e=glift.dom.newDiv(c),c=this.theme.statusBar.gameInfo,f=this.positioning.fullWidgetBbox(),g={position:"absolute",margin:"0px",padding:"0px",top:f.top()+"px",left:f.left()+"px",width:f.width()+"px",height:f.height()+"px","z-index":100};e.css(g);b=glift.dom.newDiv(b+
"_gameinfo_textdiv");f=glift.obj.flatMerge({position:"relative",margin:"0px",padding:"0px","overflow-y":"auto",height:f.height()+"px",width:f.width()+"px"},c.textDiv);b.css(f);if(glift.platform.isMobile())b.on("touchend",function(){e.remove()});else b.on("click",function(){e.remove()});f=[];for(g=0;g<a.length;g++){var h=a[g];f.push("<strong>"+h.displayName+": </strong>"+h.value)}b.append(glift.dom.newElem("h3").appendText("Game Info").css(glift.obj.flatMerge(c.textTitle,c.text))).append(glift.dom.convertText(f.join("\n"),
glift.obj.flatMerge(c.textBody,c.text))).css({padding:"10px"});e.append(b);d.prepend(e)},fullscreen:function(){var a=this.widget,b=a.wrapperDiv+"_fullscreen",c=glift.dom.newDiv(b),d=glift.dom.elem(document.body),e=a.getCurrentState(),f=a.manager,g=glift.obj.flatMerge({position:"absolute",top:"0px",bottom:"0px",left:"0px",right:"0px",margin:"0px",padding:"0px","z-index":11E4},this.theme.statusBar.fullscreen);c.css(g);d.addClass("glift-fullscreen-no-scroll").append(c);f.prevScrollTop=window.pageYOffset||
document.body.scrollTop||document.documentElement.scrollTop||null;window.scrollTo(0,0);f.fullscreenDivId=b;a.destroy();a.wrapperDiv=b;a.draw();a.applyState(e);f.enableFullscreenAutoResize()},unfullscreen:function(){if(this.widget.manager.fullscreenDivId){var a=this.widget,b=glift.dom.elem(a.wrapperDiv),c=a.getCurrentState(),d=a.manager,e=glift.dom.elem(document.body),c=a.getCurrentState();a.destroy();b.remove();a.wrapperDiv=a.manager.divId;window.scrollTo(0,d.prevScrollTop||0);e.removeClass("glift-fullscreen-no-scroll");
d.fullscreenDivId=null;d.prevScrollTop=null;a.draw();a.applyState(c);a.manager.disableFullscreenAutoResize()}},setMoveNumber:function(a){if(this.iconBar.hasIcon("move-indicator")){a=(a||"0")+"";var b=this.theme.statusBar.icons.DEFAULT.fill;this.iconBar.addTempText("move-indicator",a,{fill:b,stroke:b},2<a.length?0.35:null)}},setPageNumber:function(a,b){if(this.iconBar.hasIcon("widget-page")){var c=this.theme.statusBar.icons.DEFAULT.fill;this.iconBar.addTempText("widget-page",(a||"0")+"",{fill:c,stroke:c},
0.85)}}};glift.displays.position={};glift.displays.position.WidgetBoxes=function(){this._second=this._first=void 0};
...
glift.rules.movetree={getInstance:function(a){var b=new glift.rules._MoveTree(glift.rules.movenode());void 0!==a&&b._setIntersections(a);return b},getFromSgf:function(a,b){b=b||[];if("string"===glift.util.typeOf(b)||"number"===glift.util.typeOf(b))b=glift.rules.treepath.parseInitPosition(b);if(void 0===a||""===a)return glift.rules.movetree.getInstance(19);glift.util.majorPerfLog("Before SGF parsing in movetree");var c=glift.sgf.parse(a);glift.util.majorPerfLog("After SGF parsing in movetree");for(var d=
0;d<b.length;d++)c.moveDown(b[d]);return c},getFromNode:function(a){return new glift.rules._MoveTree(a)},searchMoveTreeDFS:function(a,b){b(a);for(var c=0;c<a.node().numChildren();c++)glift.rules.movetree.searchMoveTreeDFS(a.moveDown(c),b);a.moveUp()}};glift.rules._MoveTree=function(a,b){this._rootNode=a;this._currentNode=b||a;this._markedMainline=!1};
glift.rules._MoveTree.prototype={node:function(){return this._currentNode},properties:function(){return this.node().properties()},moveDown:function(a){a=void 0===a?0:a;void 0!==this.node().getChild(a)&&(this._currentNode=this.node().getChild(a));return this},moveUp:function(){var a=this._currentNode.getParent();a&&(this._currentNode=a);return this},getCurrentPlayer:function(){var a=glift.enums.states,b={W:"WHITE",B:"BLACK"},c=this._currentNode;if(this.properties().contains("PL"))return b[this.properties().getOneValue("PL")];
for(b=c.properties().getMove();!b;){c=c.getParent();if(!c)return a.BLACK;b=c.properties().getMove()}return b?b.color===a.BLACK?a.WHITE:a.BLACK:a.BLACK},newTreeRef:function(){return new glift.rules._MoveTree(this._rootNode,this._currentNode)},getTreeFromRoot:function(a){var b=glift.rules.movetree.getFromNode(this._rootNode);if(a&&"array"===glift.util.typeOf(a))for(var c=0,d=a.length;c<d&&0<b.node().numChildren();c++)b.moveDown(a[c]);return b},addNode:function(){this.node().addChild();this.moveDown(this.node().numChildren()-
1);return this},deleteNode:function(){throw"Unfinished";},findNextMove:function(a,b){for(var c=this.node().children,d=glift.sgf.colorToToken(b),e={},f=0;f<c.length;f++){var g=c[f];g.properties().contains(d)&&""!=g.properties().getOneValue(d)&&(e[g.properties().getAsPoint(d).hash()]=g.getVarNum())}return void 0!==e[a.hash()]?e[a.hash()]:null},getIntersections:function(){var a=this.getTreeFromRoot(),b=glift.sgf.allProperties;return a.properties().contains(b.SZ)?parseInt(a.properties().getAllValues(b.SZ)):
19},getLastMove:function(){return this.properties().getMove()},movesToMainline:function(){for(var a=this.newTreeRef(),b=0;!a.onMainline()&&a.node().getParent();b++)a.moveUp();return b},nextMoves:function(){for(var a=this.node(),b=[],c=0;c<a.numChildren();c++){var d=a.getChild(c).properties().getMove();d&&b.push(d)}return b},onMainline:function(){if(!this._markedMainline){var a=this.getTreeFromRoot();for(a.node()._mainline=!0;0<a.node().numChildren();)a.moveDown(),a.node()._mainline=!0;this._markedMainline=
!0}return this.node()._mainline},rebase:function(){for(var a=this.treepathToHere(),b=this.getTreeFromRoot(),c=this.getCurrentPlayer(),d=glift.rules.movetree.getInstance(),e={BLACK:"AB",WHITE:"AW"},f=0;f<=a.length;f++){var g=b.properties().getAllStones(),h;for(h in g)for(var k=g[h],l=e[h],m=0;m<k.length;m++){var n=k[m];n&&l&&d.properties().add(l,n.toSgfCoord())}f<a.length&&b.moveDown(a[f])}var p=function(a,b){for(var c in a.properties().propMap)(0!==b.getNodeNum()||"AB"!==c&&"AW"!==c)&&b.properties().set(c,
glift.util.simpleClone(a.properties().getAllValues(c)));for(c=0;c<a.children.length;c++){var d=a.getChild(c),e=b.addChild().getChild(c);p(d,e)}};p(b.node(),d.node());a={BLACK:"B",WHITE:"W"};d.getCurrentPlayer()!==c&&d.properties().add("PL",a[c]);return d},recurse:function(a){glift.rules.movetree.searchMoveTreeDFS(this,a)},recurseFromRoot:function(a){glift.rules.movetree.searchMoveTreeDFS(this.getTreeFromRoot(),a)},toSgf:function(){return this._toSgfBuffer(this.getTreeFromRoot().node(),[]).join("")},
treepathToHere:function(){for(var a=[],b=this.newTreeRef();b.node().getParent();)a.push(b.node().getVarNum()),b.moveUp();return a.reverse()},_debugLog:function(a){void 0===a&&(a="  ");glift.util.logz(a+this.node(b).getVarNum()+"-"+this.node(b).getNodeNum());for(var b=0;b<this.node().numChildren();b++)this.moveDown(b),this._debugLog(a),this.moveUp()},_setIntersections:function(a){var b=this.getTreeFromRoot(),c=glift.sgf.allProperties;b.properties().contains(c.SZ)||this.properties().add(c.SZ,a+"");
return this},_toSgfBuffer:function(a,b){a.getParent()&&b.push("\n");(!a.getParent()||1<a.getParent().numChildren())&&b.push("(");b.push(";");for(var c in a.properties().propMap){var d=a.properties().getAllValues(c),e=c;if(0<d.length)for(var f=0;f<d.length;f++)var g=d[f].toString().replace("]","\\]"),e=e+("["+g+"]");else e+="[]";b.push(e)}f=0;for(c=a.numChildren();f<c;f++)this._toSgfBuffer(a.getChild(f),b);(!a.getParent()||1<a.getParent().numChildren())&&b.push(")");return b}};
glift.rules.problems={isCorrectPosition:function(a,b){var c=glift.enums.problemResults;if(a.properties().matches(b))return c.CORRECT;for(var d=glift.rules.treepath.flattenMoveTree(a),e={},f=0;f<d.length;f++){for(var g=d[f],h=glift.rules.movetree.getFromNode(a.node()),k=!1,l=0;l<g.length;l++)h.moveDown(g[l]),h.properties().matches(b)&&(k=!0);k?e[c.CORRECT]=!0:e[c.INCORRECT]=!0}return e[c.CORRECT]&&!e[c.INCORRECT]?a.properties().matches(b)?c.CORRECT:c.INDETERMINATE:e[c.CORRECT]&&e[c.INCORRECT]?c.INDETERMINATE:
...
(function(){glift.rules.properties=function(b){return new a(b)};var a=function(a){this.propMap=a||{}};a.prototype={add:function(a,c){glift.sgf.allProperties[a]||glift.util.logz("Warning! The property ["+a+"] is not valid and is not recognized in the SGF spec.");if("string"!==glift.util.typeOf(c)&&"array"!==glift.util.typeOf(c))c=[c.toString().replace("\\]","]")];else if("array"===glift.util.typeOf(c))for(var d=0,e=c.length;d<e;d++)"string"!==glift.util.typeOf(c[d])&&(c[d]=c[d].toString().replace("\\]",
"]"));else if(glift.util.typeOf("string"===c))c=[c.replace("\\]","]")];else throw Error("Unexpected type "+glift.util.typeOf(c)+" for item "+item);this.contains(a)?this.propMap[a]=this.getAllValues(a).concat(c):this.propMap[a]=c;return this},getAllValues:function(a){return void 0===glift.sgf.allProperties[a]?null:this.propMap[a]?this.propMap[a].slice():null},getOneValue:function(a,c){c=void 0!==c&&"number"===typeof c&&0<=c?c:0;var d=this.getAllValues(a);return d&&1<=d.length?d[c]:null},getAsPoint:function(a,
c){var d=this.getOneValue(a,c);return d?glift.util.pointFromSgfCoord(d):d},contains:function(a){return a in this.propMap},hasValue:function(a,c){if(!this.contains(a))return!1;for(var d=this.getAllValues(a),e=0;e<d.length;e++)if(d[e]===c)return!0;return!1},remove:function(a){if(this.contains(a)){var c=this.getAllValues(a);delete this.propMap[a];return c}return null},removeOneValue:function(a,c){if(this.contains(a)){for(var d=this.getAllValues(a),e=-1,f=0,g=d.length;f<g;f++)if(d[f]===c){e=f;break}-1!==
e&&(d.splice(e,1),this.set(a,d))}else return null},set:function(a,c){if(void 0!==a&&void 0!==c)if("string"===glift.util.typeOf(c))this.propMap[a]=[c.replace("\\]","]")];else if("array"===glift.util.typeOf(c)){for(var d=0;d<c.length;d++){if("string"!==glift.util.typeOf(c[d]))throw Error("When setting via an array, all values must be strings. was ["+glift.util.typeOf(c[d])+"], for value "+c[d]);c[d]=c[d].replace("\\]","]")}this.propMap[a]=c}return this},getPlacementsAsPoints:function(a){var c="";a===
glift.enums.states.BLACK?c=glift.sgf.allProperties.AB:a===glift.enums.states.WHITE&&(c=glift.sgf.allProperties.AW);return""!==c&&this.contains(c)?glift.sgf.allSgfCoordsToPoints(this.getAllValues(c)):[]},getComment:function(){return this.contains("C")?this.getOneValue("C"):null},getMove:function(){var a=glift.enums.states.BLACK,c=glift.enums.states.WHITE;return this.contains("B")?""===this.getOneValue("B")?{color:a}:{color:a,point:this.getAsPoint("B")}:this.contains("W")?""===this.getOneValue("W")?
{color:c}:{color:c,point:this.getAsPoint("W")}:null},matches:function(a){for(var c in a)if(this.contains(c)){var d=a[c];if(0===d.length)return!0;for(var e=this.getAllValues(c),f=0,g=e.length;f<g;f++)for(var h=0,k=d.length;h<k;h++)if(-1!==e[f].indexOf(d[h]))return!0}return!1},getAllStones:function(){var a=glift.enums.states,c={},d=a.WHITE;c[a.BLACK]=this.getPlacementsAsPoints(a.BLACK);c[d]=this.getPlacementsAsPoints(a.WHITE);(a=this.getMove())&&a.point&&c[a.color].push(a.point);return c},getGameInfo:function(){var a=
[],c={GN:"Game Name",PW:"White Player",PB:"Black Player",RE:"Result",AN:"Commenter",SO:"Source",RU:"Ruleset",KM:"Komi",PC:"Place Name",DT:"Date"},d;for(d in c)this.contains(d)&&a.push({prop:d,displayName:c[d],value:this.getOneValue(d)});return a}}})();
...
glift.sgf.parse=function(a){var b=/\s|\n/,c=/[A-Z]/,d=0,e=glift.rules.movetree.getInstance(),f=[],g=[],h=[],k="",l="",m=0,n=0,p=0,q=function(a){glift.sgf.parseError(m,n,l,a,!1)},r=function(){var a=f.join("");f=[];return a},s=function(){0<k.length&&(e.properties().add(k,g),g=[],k="")};(function(){for(var t=0;t<a.length;t++){n++;l=a.charAt(t);if("\n"===l&&(m++,n=0,3!==d))continue;switch(d){case 0:"("===l?(h.push(e.node().getNodeNum()),p++,d=1):b.test(l)||q("Unexpected character. Expected first non-whitespace char to be [(]");
break;case 1:";"===l?d=4:b.test(l)||q("Unexpected character. Expected char to be [;]");break;case 2:c.test(l)?(f.push(l),2<f.length&&q("Expected: length two property. Found: "+f)):"["===l?(k=r(),void 0===glift.sgf.allProperties[k]&&glift.sgf.parseError(m,n,l,"Unknown property: "+k,!0),d=3):b.test(l)?q("Unexpected whitespace in property name"):q("Unexpected character in property name");break;case 3:"]"===l&&"\\"===f[f.length-1]?f.push(l):"]"===l?(g.push(r()),d=4):f.push(l);break;case 4:if(c.test(l))s(),
f.push(l),d=2;else if("["===l)0<k.length?d=3:q("Unexpected token.  Orphan property data.");else if("("===l)p++,s(),h.push(e.node().getNodeNum());else if(")"===l){p--;s();if(0===h.length){for(;0!==e.node().getNodeNum();)e.moveUp();return e}for(var v=h.pop();e.node().getNodeNum()!==v;)e.moveUp();0===p&&(d=5)}else";"===l?(s(),e.addNode()):b.test(l)||q("Unknown token");break;case 5:b.test(l)||glift.sgf.parseError(m,n,l,"Garbage after finishing the SGF.",!0);break;default:q("Fatal Error: Unknown State!")}}0!==
e.node().getNodeNum()&&q("Expected to end up at start.")})();return e};glift.sgf.parseError=function(a,b,c,d,e){a="SGF Parsing "+(e?"Warning":"Error")+": At line ["+a+"], column ["+b+"], char ["+c+"], "+d;if(e)glift.util.logz(a);else throw Error(a);};
...
(function(){glift.controllers.base=function(){return new a};var a=function(){this.sgfString="";this.initialPosition=[];this.problemConditions={};this.goban=this.movetree=this.treepath=void 0;this.captureHistory=[]};a.prototype={initOptions:function(a){if(void 0===a)throw"Options is undefined!  Can't create controller";this.sgfString=a.sgfString||"";this.initialPosition=a.initialPosition||[];this.problemConditions=a.problemConditions||void 0;this.initialize();return this},initialize:function(a){var c=
glift.rules;this.treepath=c.treepath.parseInitPosition(a||this.initialPosition);this.movetree=c.movetree.getFromSgf(this.sgfString,this.treepath);a=c.goban.getFromMoveTree(this.movetree,this.treepath);this.goban=a.goban;this.captureHistory=a.captures;this.extraOptions();return this},extraOptions:function(a){},addStone:function(a,c){throw"Not Implemented";},recordCaptures:function(a){this.captureHistory.push(a);return this},currentMoveNumber:function(a){return this.movetree.node().getNodeNum()},pathToCurrentPosition:function(){return this.movetree.treepathToHere()},
getGameInfo:function(){return this.movetree.getTreeFromRoot().properties().getGameInfo()},getEntireBoardState:function(){return glift.bridge.intersections.getFullBoardData(this.movetree,this.goban,this.problemConditions)},getNextBoardState:function(){return glift.bridge.intersections.nextBoardData(this.movetree,this.getCaptures(),this.problemConditions)},getCaptures:function(){return 0===this.captureHistory.length?{BLACK:[],WHITE:[]}:this.captureHistory[this.currentMoveNumber()-1]},canAddStone:function(a,
c){return this.goban.placeable(a,c)},getCurrentPlayer:function(){return this.movetree.getCurrentPlayer()},currentSgf:function(){return this.movetree.toSgf()},originalSgf:function(){return this.sgfString},getIntersections:function(){return this.movetree.getIntersections()},nextMove:function(a){if(void 0===this.treepath[this.currentMoveNumber()]||void 0!==a&&this.treepath[this.currentMoveNumber()]!==a)if(a=void 0===a?0:a,0<=a&&a<=this.movetree.nextMoves().length-1)this.setNextVariation(a),this.movetree.moveDown(a);
else return null;else this.movetree.moveDown(this.treepath[this.currentMoveNumber()]);a=this.goban.loadStonesFromMovetree(this.movetree);this.recordCaptures(a);return this.getNextBoardState()},prevMove:function(){if(0===this.currentMoveNumber())return null;var a=this.getCaptures(),c=this.movetree.properties().getAllStones();this.captureHistory=this.captureHistory.slice(0,this.currentMoveNumber()-1);this.goban.unloadStones(c,a);this.movetree.moveUp();return glift.bridge.intersections.previousBoardData(this.movetree,
c,a,this.problemConditions)},setNextVariation:function(a){this.treepath=this.treepath.slice(0,this.currentMoveNumber());this.treepath.push(a%this.movetree.node().numChildren());return this},getNextVariation:function(){return this.treepath[this.currentMoveNumber()]||0},toBeginning:function(){this.movetree=this.movetree.getTreeFromRoot();this.goban=glift.rules.goban.getFromMoveTree(this.movetree,[]).goban;this.captureHistory=[];return this.getEntireBoardState()},toEnd:function(){for(;this.nextMove(););
return this.getEntireBoardState()}}})();glift.controllers.boardEditor=function(a){var b=glift.controllers,c=glift.util.beget(b.base());glift.util.setMethods(c,b.BoardEditorMethods);c.initOptions(a);return c};
...
a.marks[k][f],markPtString=(g.point?g.point:g).toString(),h[markPtString]=!0,k===c.LABEL?void 0!==e[markPtString]?(b.intersections().addMarkPt(g.point,c.VARIATION_MARKER,g.value),delete e[markPtString]):b.intersections().addMarkPt(g.point,c.LABEL,g.value):b.intersections().addMarkPt(g,k);f=1;k=glift.bridge.variationMapping(a.correctNextMoves);for(var l in e)g=e[l],g in k?b.intersections().addMarkPt(g,c.CORRECT_VARIATION,f):b.intersections().addMarkPt(g,c.VARIATION_MARKER,f),f+=1;a.lastMove&&a.lastMove.point&&
...
a.icons.splice(0,0,this.displayOptions.previousSgfIcon)));return a},getSgfObj:function(a){if(0>a||a>this.sgfCollection.length)throw Error("Index ["+a+" ] out of bounds. List size was "+this.sgfCollection.length);a=this.sgfCollection[a];if("string"===glift.util.typeOf(a)){var b={};/^\s*\(;/.test(a)?b.sgfString=a:b.url=a;a=b}a=glift.widgets.options.setSgfOptions(a,this.sgfDefaults);return this._resetIcons(a)},getSgfString:function(a,b){a.url?this.loadSgfWithAjax(a.url,a,b):b(a)},getDivId:function(){return this.fullscreenDivId?
this.fullscreenDivId:this.divId},createWidget:function(a){return new glift.widgets.BaseWidget(this.getDivId(),a,this.displayOptions,this.actions,this)},createTemporaryWidget:function(a){this.currentWidget&&this.currentWidget.destroy();a=glift.widgets.options.setSgfOptions(a,this.sgfDefaults);this.temporaryWidget=this.createWidget(a).draw()},returnToOriginalWidget:function(){this.temporaryWidget&&this.temporaryWidget.destroy();this.temporaryWidget=void 0;this.currentWidget.draw()},_nextSgfInternal:function(a){1<
!this.sgfCollection.length||(this.allowWrapAround?this.sgfColIndex=(this.sgfColIndex+a+this.sgfCollection.length)%this.sgfCollection.length:(this.sgfColIndex+=a,0>this.sgfColIndex?this.sgfColIndex=0:this.sgfColIndex>=this.sgfCollection.length&&(this.sgfColIndex=this.sgfCollection.length-1)),this.draw())},nextSgf:function(){this._nextSgfInternal(1)},prevSgf:function(){this._nextSgfInternal(-1)},clearSgfCache:function(){this.sgfCache={}},loadSgfWithAjax:function(a,b,c){a&&this.sgfCache[a]?(b.sgfString=
this.sgfCache[a],c(b)):glift.ajax.get(a,function(d){this.sgfCache[a]=d;b.sgfString=d;c(b)}.bind(this))},prepopulateCache:function(a){for(var b=0,c=0;c<this.sgfCollection.length;c++){var d=this.getSgfObj(c);this.getSgfString(d,function(){b+=1})}var e=function(c){0<c&&b<this.sgfCollection.length?window.setTimeout(function(){e(c-1)},500):a()}.bind(this);e(3)},enableFullscreenAutoResize:function(){window.onresize&&(this.oldWindowResize=window.onresize);window.onresize=function(){this.redraw()}.bind(this)},
disableFullscreenAutoResize:function(){window.onresize=this.oldWindowResize;this.oldWindowResize=null},destroy:function(){this.currentWidget&&this.currentWidget.destroy();this.currentWidget=void 0;this.temporaryWidget&&this.temporaryWidget.destroy();this.temporaryWidget=void 0;return this}};
glift.widgets.BaseWidget=function(a,b,c,d,e){this.wrapperDiv=a;this.type=b.type;this.sgfOptions=glift.util.simpleClone(b);this.displayOptions=glift.util.simpleClone(c);this.actions=d;this.manager=e;this.totalCorrectAnswers=this.numCorrectAnswers=this.correctNextSet=this.correctness=this.initialPlayerColor=this.initialMoveNumber=this.iconBar=this.commentBox=this.statusBar=this.display=this.boardRegion=this.controller=void 0};
...
this.sgfOptions.boardRegion;this.displayOptions.rotation=this.sgfOptions.rotation;glift.util.majorPerfLog("Calculated board regions");var a=glift.displays.bbox.fromDiv(this.wrapperDiv);if(0===a.width()||0===a.height())throw Error("Div has has invalid dimensions. Bounding box had width: "+a.width()+", height: "+a.height());var b=glift.displays.position.positioner(a,this.displayOptions.boardRegion,this.displayOptions.intersections,this.sgfOptions.uiComponents,this.displayOptions.oneColumnSplits,this.displayOptions.twoColumnSplits).calcWidgetPositioning(),
c=this._createDivsForPositioning(b,this.wrapperDiv);glift.util.majorPerfLog("Created divs");this.displayOptions.divId=c.BOARD;var d=glift.themes.get(this.displayOptions.theme);this.display=glift.displays.create(this.displayOptions,b.getBbox(glift.enums.boardComponents.BOARD));glift.util.majorPerfLog("Finish creating display");c.COMMENT_BOX&&(this.commentBox=glift.displays.commentbox.create(c.COMMENT_BOX,b.getBbox(glift.enums.boardComponents.COMMENT_BOX),d));glift.util.majorPerfLog("CommentBox");c.ICONBAR&&
(this.iconBar=glift.displays.icons.bar({divId:c.ICONBAR,positioning:b.getBbox(glift.enums.boardComponents.ICONBAR),icons:this.sgfOptions.icons,parentBbox:a,theme:d,allDivIds:c,allPositioning:b}).draw());glift.util.majorPerfLog("IconBar");c.ICONBAR&&this.iconBar.initIconActions(this,this.actions.iconActions);if(c.STATUS_BAR){var e=glift.util.simpleClone(this.sgfOptions.statusBarIcons);this.manager.fullscreenDivId&&glift.array.replace(e,"fullscreen","unfullscreen");1<this.manager.sgfCollection.length&&
e.splice(0,0,"widget-page");a=glift.displays.icons.bar({divId:c.STATUS_BAR,positioning:b.getBbox(glift.enums.boardComponents.STATUS_BAR),icons:e,parentBbox:a,theme:d,allDivIds:c,allPositioning:b});this.statusBar=glift.displays.statusbar.create({iconBarPrototype:a,theme:d,allPositioning:b,widget:this}).draw()}glift.util.majorPerfLog("StatusBar");c.STATUS_BAR&&this.statusBar.iconBar.initIconActions(this,this.actions.iconActions);glift.util.majorPerfLog("Before stone event creation");this._initStoneActions(this.actions.stoneActions);
this._initKeyHandlers();glift.util.majorPerfLog("After stone event creation");this._initProblemData();this.applyBoardData(this.controller.getEntireBoardState());return this},_createDivsForPositioning:function(a,b){var c={};a.map(function(a,e){var f=b+"_internal_div_"+glift.util.idGenerator.next(),g=glift.dom.newDiv(f),h={top:e.top()+"px",left:e.left()+"px",width:e.width()+"px",height:e.height()+"px",position:"absolute",cursor:"default"};g.css(h);glift.dom.elem(b).append(g);glift.dom.ux.setNotSelectable(f);
c[a]=f});return c},_initStoneActions:function(a){var b,c;b=a.mouseover;c=a.mouseout;a=this.sgfOptions.stoneClick;this.sgfOptions.stoneMouseover&&(b=this.sgfOptions.stoneMouseover);this.sgfOptions.stoneMouseout&&(c=this.sgfOptions.stoneMouseout);var d=function(a){return function(b,c){this.manager.setActive();a(b,this,c)}.bind(this)}.bind(this);b&&c&&!glift.platform.isMobile()&&this.display.intersections().setHover(d(b),d(c));a&&(b="click",glift.platform.isMobile()&&(b="touchend"),this.display.intersections().setEvent(b,
d(a)))},_initKeyHandlers:function(){if(this.displayOptions.enableKeyboardShortcuts){var a=glift.util.simpleClone(this.sgfOptions.keyMappings);this.manager.fullscreenDivId&&(a.ESCAPE="iconActions.unfullscreen.click");for(var b in a)glift.keyMappings.registerKeyAction(this.manager.id,b,a[b]);glift.keyMappings.initKeybindingListener()}},_initProblemData:function(){if(this.sgfOptions.widgetType===glift.enums.widgetTypes.CORRECT_VARIATIONS_PROBLEM){var a=glift.rules.problems.correctNextMoves(this.controller.movetree,
this.sgfOptions.problemConditions);this.correctNextSet=this.correctNextSet||{};this.numCorrectAnswers=this.numCorrectAnswers||0;this.totalCorrectAnswers=this.totalCorrectAnswers||this.sgfOptions.totalCorrectVariationsOverride||a.length;this.iconBar.addTempText("multiopen-boxonly",this.numCorrectAnswers+"/"+this.totalCorrectAnswers,{fill:"black",stroke:"black"})}},applyBoardData:function(a){a&&(this.setCommentBox(a.comment),this.statusBar&&this.statusBar.setMoveNumber(this.controller.currentMoveNumber()),
glift.bridge.setDisplayState(a,this.display,this.sgfOptions.showVariations,this.sgfOptions.markLastMove))},setCommentBox:function(a){void 0!==this.commentBox&&(a?this.commentBox.setText(a):this.commentBox.clearText());return this},reload:function(){void 0!==this.correctness&&(this.totalCorrectAnswers=this.numCorrectAnswers=this.correctNextSet=void 0);this.redraw()},getCurrentState:function(){return{currentTreepath:this.controller.pathToCurrentPosition()}},applyState:function(a){var b=glift.enums.widgetTypes;
if(this.sgfOptions.widgetType===b.REDUCED_GAME_VIEWER||this.sgfOptions.widgetType===b.GAME_VIEWER)this.controller.initialize(a.currentTreepath),this.applyBoardData(this.controller.getEntireBoardState())},redraw:function(){this.destroy();var a=this.getCurrentState();this.draw();this.applyState(a)},destroy:function(){glift.keyMappings.unregisterInstance(this.manager.id);glift.dom.elem(this.wrapperDiv)&&glift.dom.elem(this.wrapperDiv).empty();void 0!==this.keyHandlerFunc&&(document.body.keydown=null);
this.display=this.keyHandlerFunc=this.correctness=void 0}};
...
glift.widgets.options.baseOptions={sgf:void 0,sgfDefaults:{sgfString:void 0,url:void 0,widgetType:glift.enums.widgetTypes.GAME_VIEWER,initialPosition:"",boardRegion:glift.enums.boardRegions.AUTO,rotation:glift.enums.rotations.NO_ROTATION,problemCallback:function(){},problemConditions:{GB:[],C:["Correct","is correct","is the correct"]},keyMappings:{ARROW_LEFT:"iconActions.chevron-left.click",ARROW_RIGHT:"iconActions.chevron-right.click"},uiComponents:["BOARD","COMMENT_BOX","STATUS_BAR","ICONBAR"],
statusBarIcons:["game-info","move-indicator","fullscreen"],correctVariationsResetTime:void 0,totalCorrectVariationsOverride:void 0,showVariations:"MORE_THAN_ONE",markLastMove:!0,controllerFunc:void 0,icons:void 0,stoneClick:void 0,stoneMouseover:void 0,stoneMouseout:void 0},divId:"glift_display",sgfCollection:void 0,initialListIndex:0,allowWrapAround:!1,display:{goBoardBackground:"",oneColumnSplits:{first:[{component:"STATUS_BAR",ratio:0.06},{component:"BOARD",ratio:0.67},{component:"COMMENT_BOX",
ratio:0.18},{component:"ICONBAR",ratio:0.09}]},twoColumnSplits:{first:[{component:"BOARD",ratio:1}],second:[{component:"STATUS_BAR",ratio:0.07},{component:"COMMENT_BOX",ratio:0.83},{component:"ICONBAR",ratio:0.1}]},theme:"DEFAULT",previousSgfIcon:"chevron-left",nextSgfIcon:"chevron-right",drawBoardCoords:!1,disableZoomForMobile:!1,enableKeyboardShortcuts:!0},stoneActions:{click:void 0,mouseover:function(a,b,c){a={BLACK:"BLACK_HOVER",WHITE:"WHITE_HOVER"};var d=b.controller.getCurrentPlayer();b.controller.canAddStone(c,
...
b.correctness=d.INCORRECT,e(d.INCORRECT)))}},showVariations:glift.enums.showVariations.NEVER,icons:["refresh","problem-explanation","multiopen-boxonly"],controllerFunc:glift.controllers.staticProblem,correctVariationsResetTime:750};glift.widgets.options.EXAMPLE={stoneClick:function(a,b,c){},icons:[],problemConditions:{},showVariations:glift.enums.showVariations.NEVER,controllerFunc:glift.controllers.gameViewer,stoneMouseover:function(){},stoneMouseout:function(){}};
...
d(a.INCORRECT))}},showVariations:glift.enums.showVariations.NEVER,icons:["undo-problem-move","problem-explanation","multiopen-boxonly"],controllerFunc:glift.controllers.staticProblem};
